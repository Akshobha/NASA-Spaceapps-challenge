...
lable1.pack()
lable2 = tk.Label(Project, text="1.Make sure your input file's in a csv format.", anchor="w")
lable2.pack()
lable3 = tk.Label(Project, text="2.There should be no missing values in your input file.")
lable3.pack()
lable4 = tk.Label(Project, text="3.Please read a README file in this path")
lable4.pack()
lable5 = tk.Label(Project, text="4.Your device should have python, Scikit-learn,Numpy, Pytorch, Pandas and Gitpython installed.")
lable5.pack()
lable6 = tk.Label(Project, text="Are you gonna input a dataset for a model to train on?")
lable6.pack()
...
def user_input1():
    ...
    if user_input1.lower() == "yes":
        lable7 = tk.Label(Project, text="Input path of file for training(fill this field first and click submit):")
        lable7.pack()
        ...
        try:
            lable8 = tk.Label(Project, text="Can you input what's your target column(Fill this field second and click submit)")
            lable8.pack()
            ...
            lable9 = tk.Label(Project, text="Input your features(fill this field third and click enter after)")
            lable9.pack()
            ...
            btn3.pack()
            label12 = tk.Label(Project, text="Input a file to be classified(Fill this field last and then click Submit):")
            label12.pack()
        ...
        lable12 = tk.Label(Project, text="Input a dataset to classify")
        lable12.pack()
